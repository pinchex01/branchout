<template>
    <form v-on:submit.prevent="validateBeforeSubmit" method="POST" enctype="multipart/form-data">
        ...
        <fieldset v-if="step==1">
            ...
            <div v-if="organiser.individual === 'no'">
                <div class="form-group" v-bind:class="{'has-error': errors.has('name') || errors.name }">
                    ...
                    <input type="text" name="name" v-model="organiser.name" v-validate="'required|min:3'"
                ...
                <div class="form-group" v-bind:class="{'has-error': errors.has('phone') || errors.phone }">
                    <phone-input-field label="Agent Phone Number"></phone-input-field>
        ...
        <fieldset v-if="step==2">
            ...
            <div v-if="!organiser.individual" class="form-group" v-bind:class="{'has-error': errors.has('account_type') || errors.account_type }">
            ...
            <div v-if="bank_account.account_type == 'bank'" class="form-group" v-bind:class="{'has-error': errors.has('bank_account_leaf') || errors.bank_account_leaf }">
                <file-upload-input label="Photo of your ATM Card (NB: Just to verify bank account details)" name="bank_account_leaf" type="image"></file-upload-input>
        ...
        <fieldset v-if="step === 3">
            ...
            <table class="table table-stripped">
                <thead>
                    <tr>
                        <th colspan="2">Agent Profile Information</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.loading = true;
                var url = Helpers.auth_url(this.url ? this.url : '/api/organisers/create-sales-agent', App.User)
