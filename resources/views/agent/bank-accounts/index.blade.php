            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover dt-responsive" width="100%">
                    ...
                    @foreach($bank_accounts as $bank)
                        <tr>
                            <td> <a href="{{route('agent.bank-accounts.view',[$organiser->slug, $bank->id])}}">
                                    {{$bank->name}}</a>
                            ...
                            <td>
                                <a href="{{route('agent.bank-accounts.view',[$organiser->slug, $bank->id])}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> </a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
