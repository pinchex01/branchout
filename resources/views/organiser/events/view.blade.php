...
@section('page')
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4">
            ...
            <div class="card bd-success" data-step="1">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4">
            ...
            <div class="card bd-danger" data-step="2" >
        ...
        <div class="col-xs-12 col-sm-12 col-md-4">
            <div class="card bd-primary" data-step="3" >
    ...
    <div class="row">
        <!--
        <div class="col-md-12">
            <event-status-notification></event-status-notification>
        </div>
        -->
        <div class="col-md-12">
