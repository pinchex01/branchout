    ...
    <div class="panel with-nav-tabs panel-default">
        ...
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                <li class="{{menu_current_route('organiser.bank-accounts.view','active')}}">
                ...
                <li class="{{menu_current_route('organiser.bank-accounts.statements','active')}}">
                ...
                <li class="{{menu_current_route('organiser.bank-accounts.edit','active')}}">
                    <a href="{{ route('organiser.bank-accounts.edit', [$organiser->slug,$bank_account->id]) }}">
